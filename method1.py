# Hill climbing - steepest ascent method
...
for top in range(50):
    ...
    print("The fitness value of this sequence is ",fitness)
...
print("The local maxima here is ", parent1)
print("The accuracy of selected sequence is ", p1_fitness)