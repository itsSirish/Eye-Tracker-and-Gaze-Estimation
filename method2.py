...
expected_values = [[0.5, 0.5], [0, 0.5], [1, 0.5], [0.5, 0], [0.5, 1]]
...
for num in range(no_of_children):
    ...
    random_mutation_gene = random.randrange(0, 24)
    random_mutation_index = random.randrange(0, 11)
    current[random_mutation_index] = points[random_mutation_gene]
...
gen1_fitness = c1_fitness

# grandchildren run
for feature in range(num_points):
    parent1[feature] = child1[feature]  # making the most fit children the parents for next generation

for feature in range(num_points):
    parent2[feature] = child2[feature]

for feature in range(num_points):  # resetting the variables
    child1[feature] = 0
...
for num in range(no_of_children):
    ...
    # print("the fitness of gen 3 is ", c1_fitness, c2_fitness)
    # print(" ");

print("the fitness of gen 3 is ", c1_fitness, c2_fitness)
print("The grand child with most fitness", child1)
print("The grand child with second most fitness", child2)

gen2_fitness = c1_fitness

if gen1_fitness > gen2_fitness:
    print("The next generation has lower fitness")

if gen1_fitness < gen2_fitness:
    print("The next generation has higher fitness")
